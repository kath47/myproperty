...
class LocataireForm extends StatefulWidget {
  ...
  const LocataireForm({super.key,required this.onSave});
                ...
                children: [
                  Expanded(
                    ...
                    child: GestureDetector(
                      onTap: _pickImage, // Appelé lorsque l'utilisateur clique sur le conteneur
                      child: Container(
                        height: 120,
                        decoration: BoxDecoration(
                          ...
                          image: _selectedImage != null
                              ? DecorationImage(
                                  image: FileImage(_selectedImage!), // Affiche l'image sélectionnée
                                  fit: BoxFit.cover,
                                )
                              : null,
                        ),
